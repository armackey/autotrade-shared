    ...
    WatchListUpdate.prototype.updateWatchList = function (list, name, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                index = list === null || list === void 0 ? void 0 : list.findIndex(function (l, index) { return l.ticker === (data === null || data === void 0 ? void 0 : data.ticker); });
                if (index > -1)
                    list === null || list === void 0 ? void 0 : list.splice(index, 1, data);
                else
                    list = __spreadArray(__spreadArray([], list, true), [data], false);
                return [2 /*return*/, __1.WatchListModel.updateOne({ name: name }, { name: name, items: list }, { multi: true }).exec()];
            });
        });
    };
